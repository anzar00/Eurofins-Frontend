...
console.log(numbers);
console.log("Count of negative numbers containing digit 3: ".concat(count));
console.log("Negative numbers containing digit 3: ".concat(negativeNumbersWith3));
// Level 3
...
console.log(pairs);
console.log("Count of such pairs: ".concat(count));
